// tasker\frontend\src\components\BoardView.tsx
...
export const BoardView: React.FC<BoardViewProps> = ({ boardId }) => {
  ...
  return (
    <div className="flex-1 overflow-x-auto pb-4">
      ...
      {modalCard && (
        <CardModal card={modalCard} isOpen={true} onClose={closeCardModal} />
      )}
    </div>
  );
};
